...
Pages, in build order — linked once shipped, plain text while still
planned:

| Page | Covers |
|---|---|
| [Question Candidates](question-candidates.md) | the review buffer, the unified quality score, auto-promotion, parks |
