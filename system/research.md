...
**House names and evidence (v297):** a house is a place, not its containing
city and not a particular stay. An explicit address identifies it independently
of dates; a nickname can connect a future undated story to the house, while
several stays there still require honest date disambiguation. Add Landmark's
single reading supplies exact, unit-owned name occurrences. Recognized values
must not hide adjacent memories. Existing city-alias conflicts remain ambiguous
until resolved explicitly; roster refresh cannot erase or merge these decisions.
...
not a new hard grammar for already-approved bank entries.
