...
class LifehugWrapperTests(unittest.TestCase):
    def test_parser_accepts_canonical_commands(self):
        ...
        for command in [
            ...
            ["candidates-promotion-receipt", "cand-1", "--category", "A",
             "--candidate-revision", "sha256:" + "1" * 64,
             "--category-revision", "sha256:" + "2" * 64,
             "--placement-revision", "sha256:" + "3" * 64, "--json"],
            ["focus-candidate-prompt", "--candidate-id", "rec-synthetic"],
            ["focus-candidate-complete", "--candidate-id", "rec-synthetic", "--no-push", "--json"],
            ["focus-candidate-evals", "--json"],
