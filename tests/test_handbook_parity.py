...
class EmbedParityTests(unittest.TestCase):
    ...
    def test_the_harness_sees_the_four_interaction_embeds(self):
        ...
        # question_judgment, focus_curation, question_candidate,
        # focus_candidate, entity_candidate, arc_walk) — a short scan means
        # the embed grammar broke, or a page lost its embed block.
        self.assertGreaterEqual(len(_embeds()), 7)
    ...
    def test_each_seated_interaction_page_embeds_its_own_behavior_md(self):
        ...
        expected = {
            ...
            HANDBOOK_INTERACTIONS / "arc-walk.md":
                "interactions/arc_walk/prompt/behavior.md",
        }
