...
- A date goes in `date` and a stretch in `span`, and ONLY where those are
  ...
  your own, never round a decade into a year. "The summer after we moved" is
  a real thing they said and it is NOT a date — leave THIS record undated,
  and put what they said in `claims`, where relative time has a shape of its
  own.
